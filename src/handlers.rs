use actix_web::{delete, get, post, put, patch, web, HttpResponse, Responder};
...
#[patch("/tweets/{id}")]
async fn update_partial(id: web::Path<String>) -> impl Responder {
  HttpResponse::Ok().body(format!("Tweet#update {}", id))
}
